...
generate_certificate() {
  outdir=$(mktemp -d /tmp/is-my-page-certbot.XXXXX);
...
update_www_record() {
  update_record remove CNAME 'www' "is-my-page.github.io";
  sleep 1;
...
reset_acme() {
  update_record remove A 'www.is-my.page' "68.65.123.44";
  sleep 1;
  update_record add CNAME 'www.is-my.page' "is-my-page.github.io";
}

case "$1" in
  check)
    echo "TXT record:: $(dig +noall +answer _acme-challenge.is-my.page TXT | awk '{print $5}')";
  ;;
